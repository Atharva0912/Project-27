const Engine = Matter.Engine;
	...
	roofObject=new Roof(600,100,700,85);
	
	bobDiameter=40;
	
	startBobPositionX=width/2;
	startBobPositionY=height/4+500;
	bobObject1=new Bob(startBobPositionX-bobDiameter*2,585,bobDiameter);
	bobObject2=new Bob(startBobPositionX-bobDiameter,585,bobDiameter);
	bobObject3=new Bob(startBobPositionX,585,bobDiameter);
	bobObject4=new Bob(startBobPositionX+bobDiameter,585,bobDiameter);
	bobObject5=new Bob(startBobPositionX+bobDiameter*2,585,bobDiameter);
